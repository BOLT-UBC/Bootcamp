      ...
      <div className="display-screen-widget">
        <div className="display-screen">
          ...
          <p className="about-content">
            ...
            together students, industry professionals, and academic experts for
            a{" "}
            <b>
          ...
          <p>
            ...
            <b>USS, WiDS, and WiCS</b>, providing students with an opportunity
            to gain valuable industry insights, develop technical and business
